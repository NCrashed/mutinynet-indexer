...
- `clean-regtest` - A script that removes the local Mutiny node's state, allowing you to start from scratch.
...
- `start-regtest` - Launches the local Mutiny node for testing.